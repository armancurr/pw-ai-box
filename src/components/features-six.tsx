          ...
          <div className="mt-16 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
            <Card variant="soft" className="overflow-hidden p-6">
              ...
              <h3 className="text-foreground mt-5 text-lg font-semibold">
                RAG-Powered Query Retrieval
              </h3>
              <p className="text-muted-foreground mt-3 text-balance">
                Our AI uses retrieval-augmented generation to fetch and
                synthesize accurate information from university knowledge bases.
              </p>
            ...
            <Card variant="soft" className="group overflow-hidden px-6 pt-6">
              ...
              <p className="text-muted-foreground mt-3 text-balance">
                AI ensures the reliability of answers by cross-referencing
                multiple sources and detecting potential inaccuracies.
              </p>
            ...
            <Card variant="soft" className="group overflow-hidden px-6 pt-6">
              ...
              <p className="text-muted-foreground mt-3 text-balance">
                A personalized AI tutor that remembers your academic history and
                provides context-aware guidance for deeper understanding.
              </p>
...
const MeetingIllustration = () => {
  return (
    <Card aria-hidden className="mt-9 aspect-video p-4">
      ...
      <div className="mb-0.5 text-sm font-semibold">Academic Query Session</div>
    ...
    <div aria-hidden className="relative mt-6">
      <Card className="aspect-video w-4/5 translate-y-4 p-3 transition-transform duration-200 ease-in-out group-hover:-rotate-3">
        <div className="mb-3 flex items-center gap-2">
          ...
          <span className="text-muted-foreground/75 text-xs">5m</span>
        </div>
    ...
    >
      <div className="w-fit">
        ...
        <p className="mt-2 line-clamp-2 text-sm">
          Explain the concept of retrieval-augmented generation and how it helps
          in academic research.
        </p>
      </div>
      <div className="bg-foreground/5 -mx-3 -mb-3 mt-3 space-y-3 rounded-lg p-3">
        <div className="text-muted-foreground text-sm">Ask AI Arcade</div>
